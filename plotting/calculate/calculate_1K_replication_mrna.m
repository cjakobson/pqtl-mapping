function cis_pqtn_data=calculate_1K_replication_mrna(dependency_directory,output_directory)
...
%         'FileType','text');
    mrna_1002_data=readtable([dependency_directory '230502_transcriptomes.csv'],...
        'FileType','text');
    ...
    v_proteomic_strains=mrna_1002_data.Properties.VariableNames(2:end);
    ...
    for i=1:height(cis_pqtn_data)
        ...
        %protein_idx=ismember(mrna_1002_data.Protein_Group,protein_query);
        protein_idx=ismember(mrna_1002_data.Var1,protein_query);
        ...
        if sum(protein_idx)>0
            ...
            cis_pqtn_data.rm_array{i}=table2array(mrna_1002_data(protein_idx,v_rm+1));
            cis_pqtn_data.het_array{i}=table2array(mrna_1002_data(protein_idx,v_het+1));
            cis_pqtn_data.yjm_array{i}=table2array(mrna_1002_data(protein_idx,v_yjm+1));
